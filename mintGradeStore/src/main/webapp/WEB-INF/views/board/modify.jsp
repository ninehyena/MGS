...
<div class="getPage">
	...
	<br>
	<br>
	<form role="form" action="/board/modify" method="post" style="margin: 0px 0px 0 12px;">
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> <input type="hidden" name="bno" value="${board.bno}" /> <input type="hidden" name="pageNum" value="${cri.pageNum}" />
		...
		<!-- 폼을 생성하여 게시물 번호를 숨김값으로 전달. -->
		<!-- 소스 보기로는 보이지만 웹 브라우저 화면에서는 표시하지 않는다. -->
		...
		<div class="form-group">
			<label>콘솔 이름</label>
			<input class="form-control" name="consoleName" value='<c:out value="${board.consoleName}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>게임 이름</label>
			<input class="form-control" name="gameName" value='<c:out value="${board.gameName}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>게임 상세 이름</label>
			<input class="form-control" name="gameNameOriginal" value='<c:out value="${board.gameNameOriginal}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>발매 연도</label>
			<input class="form-control" name="gameReleaseDate" value='<c:out value="${board.gameReleaseDate}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>발매 연도 상세</label>
			<input class="form-control" name="gameReleaseDateYMD" value='<c:out value="${board.gameReleaseDateYMD}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>제품 상태</label>
			<input class="form-control" name="gameCondition" value='<c:out value="${board.gameCondition}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>제품 가격</label>
			<input class="form-control" name="gamePrice" value='<c:out value="${board.gamePrice}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>감정 등급</label>
			<input class="form-control" name="gameGrade" value='<c:out value="${board.gameGrade}" />'>
		</div>
		<br>
		<div class="form-group">
			<label>내용</label>
