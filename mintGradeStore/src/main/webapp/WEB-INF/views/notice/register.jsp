...
<div class=writePage>
	...
	<br>
	<br>
	<form role="form" action="/notice/register" method="post" style="margin: 0px 0px 0 12px;">
		...
		<div class="form-group">
			<label>카테고리</label>
			<input class="form-control" name="category" placeholder="* 카테고리를 입력해주세요.">
		</div>
		<br>
		<div class="form-group">
			<label>공지 제목</label>
			<input class="form-control" name="title" placeholder="* 공지 제목을 입력해주세요.">
		</div>
		<br>
		<div class="form-group">
			<label>공지 내용</label>
			<textarea class="form-control" name="content" rows="3" placeholder="* 공지 내용을 입력해주세요."></textarea>
		</div>
		<br>
		<br>
